"""
 ...
 Class for ORM model described an wait dataset upload job
...
from wb.main.models import JobsModel, DatasetsModel
from wb.main.models.datasets_model import DatasetJobData


class WaitDatasetUploadJobsModel(JobsModel):
    __tablename__ = 'wait_dataset_upload_jobs'

    __mapper_args__ = {
        'polymorphic_identity': JobTypesEnum.wait_upload_dataset_type.value
    }
    ...
    dataset: DatasetsModel = relationship(DatasetsModel, foreign_keys=[dataset_id],
                                          backref=backref('wait_dataset_upload_job', lazy='subquery',
