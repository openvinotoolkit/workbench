"""
 ...
 Class for ORM model describing a dataset downloading job
...
class DownloadDatasetJobsModel(JobsModel):
    __tablename__ = 'download_dataset_jobs'

    __mapper_args__ = {
        'polymorphic_identity': JobTypesEnum.download_dataset_type.value
    }
    ...
    dataset: DatasetsModel = relationship(DatasetsModel, foreign_keys=[dataset_id],
                                          backref=backref('download_dataset_job', lazy='subquery',
