...
@Component({
  selector: 'wb-model-details-tab-content',
  templateUrl: './model-details-tab-content.component.html',
  styleUrls: ['./model-details-tab-content.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ModelDetailsTabContentComponent {
