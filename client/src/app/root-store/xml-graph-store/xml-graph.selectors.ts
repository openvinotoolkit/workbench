...
const selectXMLGraphState = createFeatureSelector<AppState, XMLGraphState>(fromXMLGraphStore.xmlGraphStoreFeatureKey);
...
export const selectOriginalGraphId = createSelector(
  selectOriginalGraph,
  getGraphId
);
...
export const selectRuntimeGraphId = createSelector(
  selectRuntimeGraph,
  getGraphId
);
